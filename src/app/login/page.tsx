...
// Next 16 prerender requires every useSearchParams() consumer to live
// under a <Suspense> boundary. The default export wraps the real form
// component (LoginForm) so the build can statically render the shell.
      ...
      <div className="relative hidden flex-col items-center justify-center gap-12 overflow-hidden px-12 py-12 text-white lg:flex">
        ...
        <div className="relative max-w-[480px] text-center">
          ...
          <p className="mt-4 text-[15px] leading-[1.6] text-white/70">
            From bid capture to field execution — SCM replaces the spreadsheets, the email threads,
            and the back-of-envelope math with a single source of truth, powered by AI.
          </p>
        </div>
